...
class FilterServiceProvider extends ServiceProvider
{
    ...
    {
        $builder = class_exists(\Laravel\Scout\Builder::class)
                     ? \Laravel\Scout\Builder::class 
                     : \Illuminate\Database\Eloquent\Builder::class;

        $this->configureBuilderMacro($builder);
    }
    
    private function configureBuilderMacro($builder)
    {
        $builder::macro('filterFromUrl', function($default = null) {
